...
// Отправляем ответ
ТекстОтвета = СтрЗаменить(ТекстовыеДанныеСКлиента, "My name is ", "Hello") + " !";
ДДОтвета = ПолучитьДвоичныеДанныеИзСтроки(ТекстОтвета);
Сообщить("sending: " + ТекстОтвета);
Соединение.ОтправитьДвоичныеДанные(ДДОтвета);
